// src/main/java/com/example/inventarioventasgym/config/KafkaConsumerConfig.java
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ClienteEventDTO> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "inventario-ventas-consumer-group");
        ...
        props.put(org.springframework.kafka.support.serializer.JsonDeserializer.VALUE_DEFAULT_TYPE, ClienteEventDTO.class);
        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ClienteEventDTO> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, ClienteEventDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
